...
if __name__ == "__main__":
    pdf_path = r"C:\Users\bksh1\Desktop\final\scripts\samples\sample1.pdf"  # Path to your original PDF
    data_path = r"C:\Users\bksh1\Desktop\final\scripts\data\data.txt"  # Raw string
    output_pdf_path = r"C:\Users\bksh1\Desktop\final\scripts\outputs\filled_sample1.pdf"  # Path to save the filled PDF
